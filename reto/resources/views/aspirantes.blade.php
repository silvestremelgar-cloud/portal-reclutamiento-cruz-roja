...
<section class="seccion">
    ...
    <div class="seccion">
    <h2>Temporada de inscripción</h2>
    <p> <strong>Cupos totales:</strong> 50</p>
    <p> <strong>Inscritos:</strong> {{ $aspirantes->count() }} </p>
    <p> <strong>Cupos disponibles:</strong> {{ max(0, 50 - $aspirantes->count()) }}</p></div>
