...
Route::get('/aspirantes', function () { $aspirantes = Aspirante::all(); return view('aspirantes', compact('aspirantes'));});
Route::get('/aspirantes/nuevo', function () { return view('aspirantes-nuevo' );});
